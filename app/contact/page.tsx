      ...
      <div className="flex flex-col items-center md:flex md:flex-row md:flex-1 gap-[2rem] md:gap-[3rem]">
        ...
        <form className="flex flex-col max-w-[30rem] md:max-w-[50rem] md:flex md:flex-row">
          ...
          <div className="mt-3 flex-1 md:ml-4">
            <textarea
              id="large-input"
              className="w-full h-[10rem] md:h-full p-4  rounded-lg sm:text-md focus:ring-blue-500 focus:border-blue-500 bg-gray-700 border-gray-600 placeholder-gray-400 text-white focus:ring-blue-500 focus:border-blue-500 flex items-center justify-center"
              placeholder="Message"
            ></textarea>
          </div>
        </form>
      </div>
      <div className="my-6 w-[100%] md:w-[60vw] h-[325px]">
        <iframe
